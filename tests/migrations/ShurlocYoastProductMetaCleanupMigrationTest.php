 ...
 */
final class ShurlocYoastProductMetaCleanupMigrationTest extends TestCase {

	/**
	 * Migration under test.
	 *
	 * @var Shurloc_Yoast_Product_Meta_Cleanup_Migration
	 */
	private Shurloc_Yoast_Product_Meta_Cleanup_Migration $migration;
	...
	public function test_run_records_last_run_metadata(): void {
		...
		$last_run =
			$GLOBALS['shurloc_test_options']
				[ Shurloc_Yoast_Product_Meta_Cleanup_Migration::LAST_RUN_OPTION ];
		...
		self::assertSame(
			Shurloc_Yoast_Product_Meta_Cleanup_Migration::VERSION,
			$GLOBALS['shurloc_test_options']
				[ Shurloc_Yoast_Product_Meta_Cleanup_Migration::LAST_RUN_VERSION_OPTION ]
		);
	}
	...
	public function test_get_last_run_returns_stored_timestamp(): void {
		...
		$GLOBALS['shurloc_test_options']
			[ Shurloc_Yoast_Product_Meta_Cleanup_Migration::LAST_RUN_OPTION ] = 1_000_000;
	...
	public function test_get_last_run_version_returns_stored_version(): void {
		...
		$GLOBALS['shurloc_test_options']
			[ Shurloc_Yoast_Product_Meta_Cleanup_Migration::LAST_RUN_VERSION_OPTION ] = 2;
	...
	public function test_is_locked_returns_true_for_active_lock(): void {
		...
		$GLOBALS['shurloc_test_options']
			[ Shurloc_Yoast_Product_Meta_Cleanup_Migration::LOCK_OPTION ] = $locked_at;
	...
	public function test_is_locked_removes_stale_lock(): void {
		...
		self::assertArrayNotHasKey(
			Shurloc_Yoast_Product_Meta_Cleanup_Migration::LOCK_OPTION,
			$GLOBALS['shurloc_test_options']
		);
	}
	...
	public function test_acquire_lock_returns_false_when_already_locked(): void {
		...
		$GLOBALS['shurloc_test_options']
			[ Shurloc_Yoast_Product_Meta_Cleanup_Migration::LOCK_OPTION ] = time();
	...
	public function test_acquire_lock_replaces_stale_lock(): void {
		...
		$GLOBALS['shurloc_test_options']
			[ Shurloc_Yoast_Product_Meta_Cleanup_Migration::LOCK_OPTION ] = $stale_lock;
