 ...
 */
final class ShurlocPrimaryProductCategoryMetaboxTest extends TestCase {

	/**
	 * Primary category service.
	 *
	 * @var Shurloc_Primary_Product_Category_Service
	 */
	private Shurloc_Primary_Product_Category_Service $service;

	/**
	 * Metabox under test.
	 *
	 * @var Shurloc_Primary_Product_Category_Metabox
	 */
	private Shurloc_Primary_Product_Category_Metabox $metabox;
	...
	public function test_save_stores_valid_primary_category(): void {
		...
		self::assertSame(
			...
			$GLOBALS['shurloc_test_post_meta'][100]
				[ Shurloc_Primary_Product_Category_Service::META_KEY ]
		);
	}
	...
	public function test_save_clears_primary_category_when_empty(): void {
		...
		$GLOBALS['shurloc_test_post_meta'][100]
			[ Shurloc_Primary_Product_Category_Service::META_KEY ] = 10;
