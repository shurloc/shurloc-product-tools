 ...
 */
final class ShurlocProductMigrationsControllerTest extends TestCase {
	 ...
	 */
	private Shurloc_Product_Migrations_Controller $controller;
	...
	public function test_render_shows_last_run_version(): void {
		...
		$GLOBALS['shurloc_test_options']
			[ Shurloc_Yoast_Product_Meta_Cleanup_Migration::LAST_RUN_VERSION_OPTION ] = 1;
	...
	public function test_enqueue_assets_on_migrations_page(): void {
		...
		$_GET['page'] = 'shurloc-product-tools';
		$_GET['tab']  = 'migrations';
		...
		self::assertSame(
			SHURLOC_PRODUCT_TOOLS_URL .
				'assets/js/shurloc-product-migrations.js',
			$GLOBALS['shurloc_test_scripts']
		...
		self::assertSame(
			SHURLOC_PRODUCT_TOOLS_URL .
				'assets/css/shurloc-product-migrations.css',
			$GLOBALS['shurloc_test_styles']
				['shurloc-product-migrations']['src']
		);
	}
