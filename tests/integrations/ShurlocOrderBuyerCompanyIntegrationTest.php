 ...
 */
final class ShurlocOrderBuyerCompanyIntegrationTest extends TestCase {

	/**
	 * Integration under test.
	 *
	 * @var Shurloc_Order_Buyer_Company_Integration
	 */
	private Shurloc_Order_Buyer_Company_Integration $integration;
	...
	protected function setUp(): void {
		...
		$this->integration =
			new Shurloc_Order_Buyer_Company_Integration();
	}
