 ...
 */
final class ShurlocYoastPrimaryCategoryIntegrationTest extends TestCase {

	/**
	 * Integration under test.
	 *
	 * @var Shurloc_Yoast_Primary_Category_Integration
	 */
	private Shurloc_Yoast_Primary_Category_Integration $integration;
