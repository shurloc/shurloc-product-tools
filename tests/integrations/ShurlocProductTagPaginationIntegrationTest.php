 ...
 */
final class ShurlocProductTagPaginationIntegrationTest extends TestCase {

	/**
	 * Integration under test.
	 *
	 * @var Shurloc_Product_Tag_Pagination_Integration
	 */
	private Shurloc_Product_Tag_Pagination_Integration $integration;
	...
	protected function setUp(): void {
		...
		$this->integration =
			new Shurloc_Product_Tag_Pagination_Integration();
	}
