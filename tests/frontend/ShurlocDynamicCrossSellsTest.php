 ...
 */
final class ShurlocDynamicCrossSellsTest extends TestCase {

	/**
	 * Dynamic cross-sells class under test.
	 *
	 * @var Shurloc_Dynamic_Cross_Sells
	 */
	private Shurloc_Dynamic_Cross_Sells $cross_sells;
	...
	protected function setUp(): void {
		...
		$this->cross_sells =
			new Shurloc_Dynamic_Cross_Sells( $eligibility );
	}
