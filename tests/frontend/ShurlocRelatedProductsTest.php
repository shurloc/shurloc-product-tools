 ...
 */
final class ShurlocRelatedProductsTest extends TestCase {

	/**
	 * Related-products class under test.
	 *
	 * @var Shurloc_Related_Products
	 */
	private Shurloc_Related_Products $related_products;
	...
	protected function setUp(): void {
		...
		$this->related_products =
			new Shurloc_Related_Products( $eligibility );
	}
