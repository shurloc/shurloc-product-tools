 ...
 */
final class Shurloc_Product_Migrations_Controller {

	/**
	 * Admin page slug.
	 */
	private const PAGE_SLUG = 'shurloc-product-tools';
	 ...
	 */
	private Shurloc_Yoast_Product_Meta_Cleanup_Migration $cleanup_migration;

	/**
	 * Constructor.
	 *
	 * @param Shurloc_Yoast_Product_Meta_Cleanup_Migration $cleanup_migration Cleanup migration.
	 */
	public function __construct(
		Shurloc_Yoast_Product_Meta_Cleanup_Migration $cleanup_migration
	) {
				...
				<tbody>
					<tr>
						...
						<td>
							<?php
							echo esc_html(
								(string) Shurloc_Yoast_Product_Meta_Cleanup_Migration::VERSION
							);
							?>
						</td>
					</tr>
