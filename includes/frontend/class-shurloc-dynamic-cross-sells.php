 ...
 */
final class Shurloc_Dynamic_Cross_Sells {
	 ...
	 *
	 * @var Shurloc_Product_Recommendation_Eligibility_Service
	 */
	private Shurloc_Product_Recommendation_Eligibility_Service $eligibility;

	/**
	 * Constructor.
	 *
	 * @param Shurloc_Product_Recommendation_Eligibility_Service $eligibility Product recommendation eligibility service.
	 */
	public function __construct(
		Shurloc_Product_Recommendation_Eligibility_Service $eligibility
	) {
